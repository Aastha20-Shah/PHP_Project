...
$doc_query = "SELECT u.*, c.category_name, 
              ...
              WHERE u.id = ? AND u.role_id = 2 AND u.verification_status = 'verified'
              GROUP BY u.id";
...
$page_title = 'Dr. ' . trim((string)($doctor['firstname'] ?? '')) . ' ' . trim((string)($doctor['lastname'] ?? ''));
?>
            ...
            <div class="card info-card">
                <div class="card-body p-4">
                    ...
                    <div class="payment-box">
                        ...
                        <p class="mb-0 text-dark small"><strong>Please note:</strong> Payment is done after the bill is generated. You can pay at the clinic/hospital (Cash) or pay online from your bill. No online payment is required to book this appointment.</p>
                    </div>
                </div>
            </div>
        </div>
